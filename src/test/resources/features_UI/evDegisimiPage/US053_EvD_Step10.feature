#US_053	Bir kullanıcı olarak "Ev Değişimi" ilan oluşturma sayfasında,
# 10. stepte en az 5 en fazla 10 tane resim ekleyebilmeliyim.
# https://kese.nl/new_home
#En az 5 tane resim ekleyebilmeliyim.
#En fazla 10 tane resim ekleyebilmeliyim.
#5 resim ekledikten sonra "Resimleri Kaydet" butonu tıklabilir olmalıdır.
