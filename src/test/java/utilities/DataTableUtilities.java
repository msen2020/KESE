...
public class DataTableUtilities {
    ...
    public static void createConnection() {
        ...
        try {
            ...
            System.out.println("connection saglandi");
    ...
    public static void closeConnection() {
        try {
            if (resultSet != null) {
                resultSet.close();
            System.out.println("result set kesildi");
            }
            if (statement != null) {
                statement.close();
            System.out.println("statement kesildi");
            }
            if (connection != null) {
                connection.close();
            System.out.println("connection kesildi");
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    //******************** HYPNOTES ICIN EKLENENLER *******************//
    public static void getUserDetails(String query){
        executeQuery(query);
    }
}
